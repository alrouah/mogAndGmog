...
const CONTRACT_NAME = "GogAndMagog"; // Contract name must be the same as the file name without the extension
...
export default async function (hre: HardhatRuntimeEnvironment) {
  ...
  const deploymentFee = await deployer.estimateDeployFee(artifact, [admin]);
